...
public class gridViewSessionDisplay extends gridView {

    private NewSessionActivity m_parentSession;

    public gridViewSessionDisplay(Context context){
        this(context, null);
    }
        public gridViewSessionDisplay(Context context, AttributeSet attrs){
            super(context, attrs);
    ...
    protected void setM_parentSession(NewSessionActivity parent){
